$(function() {
	...
	$(function() {
		var div1 = '\
        <div id="key" style="position:absolute;background-color:#d1d5da;width:100%;bottom:0px;">\
		<ul class="write"  id="keyboard" style="font-size:20px;">\
			...
			';
		var div2 = '\
        <div id="key" style="position:absolute;background-color:#A8A8A8;width:100%;bottom:0px;">\
            <ul class="number"  id="keyboard" style="font-size:20px; padding-bottom:.2rem;">\
				<li class="tab_sure"><span class="sure">确定</span></li>\
